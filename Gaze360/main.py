...
from data_loader import get_train_loader, get_test_loader, get_validation_loader
...
def run(config):
    ...
    wandb.init(project='technical_report_Gaze360')
    ...
    # instantiate trainer
    trainer = Trainer(config, data_loader, load_mode, val_loader=val_loader, test_loader=test_loader)
