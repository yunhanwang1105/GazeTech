...
train_arg.add_argument('--contiue_train_model_path', type=str, default='./ckpt/epoch_xx_ckpt.pth.tar',
                      help='Directory in which to contiue training on')

# model building
train_arg.add_argument('--model_name', type=str, default='face_res50',
                       help='The name of the model to train: face_res50, multi_region_res50, multi_region_res50_share_eyenet')
train_arg.add_argument('--in_stride', type=int, default=2,
                       help='The stride of the first conv-layer of CNN')
...
misc_arg.add_argument('--pre_trained_model_path', type=str, default='./ckpt/epoch_14_0.0001_ckpt.pth.tar',
